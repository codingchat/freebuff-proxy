...
//
//	openai.go        /v1/chat/completions (relayStream/relayJSON)
//	responses.go     /v1/responses (RelayResponsesStream/JSON)
//	anthropic.go     /v1/messages (+ anthropic_errors.go, streamxml_anthropic.go)
